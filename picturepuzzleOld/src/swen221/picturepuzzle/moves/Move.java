...
public class Move implements Operation {
	...
	public void apply(Board board) {
		...
		System.out.println("Blank at: " + blank.col + " y: " + blank.row);
		...
		if (nextTo(location,blank)) {
			...
			System.out.println("Is next to: " + location.col + " y:" + location.row) ;
	...
	public static boolean nextTo(Location l1, Location l2) {
		return (l1.row == l2.row && Math.abs(l1.col - l2.col) == 1) ||
				(l1.col == l2.col && Math.abs(l1.row - l2.row) == 1);
	}
}
